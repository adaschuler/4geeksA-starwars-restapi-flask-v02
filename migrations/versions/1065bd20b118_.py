...
Revision ID: 1065bd20b118
Revises: 
Create Date: 2021-07-26 23:23:16.570999
...
def upgrade():
    ...
    sa.PrimaryKeyConstraint('id', 'favorites')
    )
    ...
    sa.ForeignKeyConstraint(['favorites'], ['favorites_people.id'], ),
    sa.PrimaryKeyConstraint('id'),
